  ...
  return (
    <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3 gap-8 px-4 py-14'>
      ...
      <div className='lg:col-span-2 flex flex-col justify-center'>
        ...
        <div className='grid sm:grid-cols-2 gap-8 mt-8'>
          {[{ icon: RiCustomerService2Fill, text: 'Leading Service' }, { icon: MdOutlineTravelExplore, text: 'Explore Locations' }].map((item, index) => (
            <div key={index} className='flex flex-col items-center justify-center bg-white bg-opacity-30 backdrop-blur-lg border border-gray-200 rounded-lg p-6 shadow-md'>
              <button className='text-blue-500 bg-blue-50 bg-opacity-30 backdrop-blur-lg border border-gray-200 rounded-full p-3 mb-4'>
                <item.icon size={40}/>
              </button>
      ...
      <div className='lg:text-center lg:py-8 lg:col-start-3'>
        <div className='bg-white bg-opacity-30 backdrop-blur-lg border border-gray-200 text-blue-500 px-8 py-12 rounded-lg shadow-md'>
          ...
          <button className='bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-400 transition duration-300'>Book Now</button>
        </div>
      </div>
    </div>
  );

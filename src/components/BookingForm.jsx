...
const BookingForm = () => {
  ...
  return (
    <div>
      <header className="fixed w-full z-50 bg-opacity-20 backdrop-filter backdrop-blur-lg border-b border-white border-opacity-30">
        <div className="text-5xl max-sm:text-4xl max-w-7xl max-sm:py-1 mx-auto px-3 text-center py-2">
          <div className=" font-bold text-white">Holidays</div>
        </div>
      </header>
      ...
      <div className="w-full h-screen relative flex items-center justify-center">
        ...
        <div className="absolute w-full h-full flex items-center justify-center  bg-black bg-opacity-50">
          {!submitted ? (
            <form onSubmit={handleSubmit} className="absolute bg-opacity-0 text-white mt-10 p-10 border rounded-md max-w-lg w-full md:grid md:grid-cols-3 text-sm md:gap-x-2 md:p-10 overflow-y-auto max-sm:h-full">
              <h2 className="md:col-span-3 text-2xl max-sm:text-xl max-sm:mt-3  font-bold mb-4 text-center">Hotel Booking Form</h2>
